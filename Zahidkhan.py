#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To zahidullah
...
\033[1;96m:•◈•║╚╣╚╝╠╗╔╣║═╣║║║╔╗║╚═╣╔╗╣║═╣║    
\033[1;96m:•◈•╚═╩══╝╚╝╚══╩╝╚╩╝╚╩══╩╝╚╩══╩╝
\033[1;97m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;94mzahidullah\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"""
...
jalan("\033[1;96m╱╱╱╱┃┃")
jalan("\033[1;96m╱╱╱╱╰╯")
jalan('\033[1;93m              Welcome to Zahidullah')
print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;96mZahidullah\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:zahid_ullah
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://https://www.facebook.com/profile.php?id=100068886914203&mibextid=ZbWKwL    ')
    else:
...
def login():
	...
	try:
		...
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;93mzahidullah\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
		...
		tik()
		try:
			br.open('https://www.facebook.com/profile.php?id=100068886914203&mibextid=ZbWKwL    ')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Zahidullah
	print logo
...
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;96m ....ZAHIDULLAH....... \033[1;93m :
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;96m 009660562957121"""
